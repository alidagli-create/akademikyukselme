...
exports.handler = async (event) => {
    try {
        ...
        for (let i = 0; i < citationFiles.length; i++) {
            ...
            // Dosya adları eşleşmese bile sıraya göre eşleştirme yap
            ...
            batchResult.push({ title, unvanImg, baslikImg, atifImgs, kaynakcaImgs });
        }
...
Bu dosyayı doğru yere (`netlify/functions/`) ekledikten sonra değişiklikleri GitHub'a gönderin. Netlify sitenizi yeniden yayınlayınca sorun çözülecektir.

**Doğru dosya yapınız şu şekilde olmalı:**
